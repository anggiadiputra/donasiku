-- Recreate campaigner_stats_view with security_invoker = true to fix the "Security Definer View" warning.
-- This ensures the view respects Row Level Security of the user querying it.

DROP VIEW IF EXISTS campaigner_stats_view;

CREATE OR REPLACE VIEW campaigner_stats_view 
